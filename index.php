    ...
    <nav class="navbar navbar-fixed-top top-bar">
        ...
        <div id="navbar" class="navbar-collapse collapse" role="navigation">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item fade-in two"><a href="#view-work" class="smoothscroll"><span class="ss-icon ss-glyphish-outline">compose</span>Work</a></li>
                <li class="nav-item fade-in three"><a href="#contact" class="smoothscroll"><span class="ss-icon ss-glyphish-outline">send</span>Contact</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li class="nav-item"><a href="https://www.linkedin.com/in/jonokane" target="_blank" class="soc-link"><span class="ss-icon ss-social-circle">linkedin</span></a></li>
                <li class="nav-item"><a href="http://www.twitter.com/nokapixel" target="_blank" class="soc-link"><span class="ss-icon ss-social-circle">twitter</span></a></li>
                <li class="nav-item"><a href="http://facebook.com/jonokane" target="_blank" class="soc-link"><span class="ss-icon ss-social-circle">facebook</span></a></li>
                <li class="nav-item"><a href="http://www.flickr.com/photos/nokapixel" target="_blank" class="soc-link"><span class="ss-icon ss-social-circle">flickr</span></a></li>
            </ul>
        </div>
        <!--/.nav-collapse -->
    </nav>
    <!-- <div id="spyOnThis" data-spy="scroll" data-target="#navbar"> -->
        <div class="container">
            <section class="hero-intro">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="elegant fade-in one">Looking for a great User Experience Designer?</h4>
                    </div>
                </div>
        ...
        <section class="content-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-12" id="view-work">
                        ...
                        <form name="contact_form" id="JqAjaxForm" class="">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button class="btn btn-submit-ghost-off" value="submit" id="contact-submit">Say Hello</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <ul>
                            ...
                            <li><a href="http://www.twitter.com/nokapixel" target="_blank" class="soc-link"><span class="ss-icon ss-social-circle">twitter</span> /nokapixel</a></li>
                            <li><a href="http://facebook.com/jonokane" target="_blank" class="soc-link"><span class="ss-icon ss-social-circle">facebook</span> /jonokane</a></li>
                            <li><a href="http://www.flickr.com/photos/nokapixel" target="_blank" class="soc-link"><span class="ss-icon ss-social-circle">flickr</span> /nokapixel</a></li>
                        </ul>
                    </div>
                </div>
                <div class="row">
